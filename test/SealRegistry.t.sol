...
contract SealRegistryTest is Test {
    ...
    function testIssueSealA2H_HappyPath() public {
        ...
        uint256 sealId =
            sealRegistry.issueSealA2H(human1, SKILLFUL, 85, EVIDENCE_HASH, uint48(block.timestamp + 1 days));

        SealRegistry.Seal memory seal = sealRegistry.getSeal(sealId);

        assertEq(uint256(seal.sealType), uint256(SKILLFUL));
    ...
    function testIssueSealH2A_HappyPath() public {
        ...
        assertEq(uint256(seal.sealType), uint256(FAIR));
    ...
    function testIssueSealH2H_HappyPath() public {
        ...
        assertEq(uint256(seal.sealType), uint256(CREATIVE));
    ...
    function testIssueSealA2H_UnauthorizedSealType() public {
        vm.expectRevert(abi.encodeWithSelector(SealRegistry.AgentNotAuthorizedForSealType.selector, agent1, FAIR));
    ...
    function testIssueSealA2H_UnregisteredAgent() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(SealRegistry.AgentNotRegistered.selector, unregisteredAgent));
    ...
    function testExpiredSealDetection() public {
        ...
        vm.prank(agent1);
        uint256 sealId = sealRegistry.issueSealA2H(human1, SKILLFUL, 85, EVIDENCE_HASH, expirationTime);
    ...
    function testEvents() public {
        ...
        emit SealRegistry.SealIssued(1, CREATIVE, human2, human1, SealRegistry.Quadrant.H2H, 75);
    ...
    function testIssueSealA2A_HappyPath() public {
        ...
        vm.prank(agent2);
        uint256 sealId = sealRegistry.issueSealA2A(AGENT1_ID, SKILLFUL, 88, EVIDENCE_HASH, 0);
    ...
    function testIssueSealA2A_UnauthorizedDomain() public {
        ...
        vm.prank(agent2);
        vm.expectRevert(abi.encodeWithSelector(SealRegistry.AgentNotAuthorizedForSealType.selector, agent2, SKILLFUL));
        sealRegistry.issueSealA2A(AGENT1_ID, SKILLFUL, 90, EVIDENCE_HASH, 0);
    }
    ...
    function _bp(address subject, bytes32 sealType, SealRegistry.Quadrant q, uint8 score, bytes32 ev, uint48 exp)
        internal
        pure
        returns (SealRegistry.BatchSealParams memory)
    {
    ...
    function testCompositeScore_ExcludesExpired() public {
        ...
        vm.warp(block.timestamp + 2 hours);
        (uint256 avgAfter, uint256 countAfter,) = sealRegistry.compositeScore(human1, false, SealRegistry.Quadrant.A2H);
    ...
    function testCompositeScore_QuadrantFilter() public {
        ...
        (uint256 avgH2H, uint256 countH2H,) = sealRegistry.compositeScore(human2, true, SealRegistry.Quadrant.H2H);
        assertEq(avgH2H, 80);
        assertEq(countH2H, 1);

        // Filter by A2H should return 0
        (uint256 avgA2H, uint256 countA2H,) = sealRegistry.compositeScore(human2, true, SealRegistry.Quadrant.A2H);
        assertEq(avgA2H, 0);
        assertEq(countA2H, 0);
    }
    ...
    function testDelegation_HappyPath() public {
        ...
        vm.prank(delegate1);
        uint256 sealId =
            sealRegistry.issueSealAsDelegate(agent1, human1, SKILLFUL, SealRegistry.Quadrant.A2H, 85, EVIDENCE_HASH, 0);
    ...
    function testDelegation_DelegateUnauthorizedType() public {
        ...
        vm.prank(delegate1);
        vm.expectRevert(
            abi.encodeWithSelector(SealRegistry.DelegateNotAuthorizedForSealType.selector, delegate1, RELIABLE)
        );
        sealRegistry.issueSealAsDelegate(agent1, human1, RELIABLE, SealRegistry.Quadrant.A2H, 85, EVIDENCE_HASH, 0);
    }
    ...
    function _signMetaTx(SealRegistry.MetaTxParams memory params, uint256 privateKey)
        internal
        view
        returns (bytes memory)
    {
        ...
        bytes32 digest = keccak256(abi.encodePacked("\x19\x01", sealRegistry.DOMAIN_SEPARATOR(), structHash));
    ...
    function testTimeWeighted_RecentVsOld() public {
        ...
        (uint256 weighted, uint256 count) =
            sealRegistry.timeWeightedScore(human2, halfLife, false, SealRegistry.Quadrant.H2H);
    ...
    function testTimeWeighted_ExcludesRevoked() public {
        ...
        (uint256 weighted, uint256 count) =
            sealRegistry.timeWeightedScore(human2, 30 days, false, SealRegistry.Quadrant.H2H);
    ...
    function testTimeWeighted_ExcludesExpired() public {
        ...
        (uint256 weighted, uint256 count) =
            sealRegistry.timeWeightedScore(human1, 30 days, false, SealRegistry.Quadrant.A2H);
    ...
    function testTimeWeighted_QuadrantFilter() public {
        ...
        (uint256 weightedH2H, uint256 countH2H) =
            sealRegistry.timeWeightedScore(human2, 30 days, true, SealRegistry.Quadrant.H2H);
        assertEq(countH2H, 1);
        assertEq(weightedH2H, 80);

        // Filter A2H → should see nothing for human2
        (uint256 weightedA2H, uint256 countA2H) =
            sealRegistry.timeWeightedScore(human2, 30 days, true, SealRegistry.Quadrant.A2H);
        assertEq(countA2H, 0);
    ...
    function testTimeWeighted_NoSeals() public {
        address nobody = makeAddr("nobody");
        (uint256 weighted, uint256 count) =
            sealRegistry.timeWeightedScore(nobody, 30 days, false, SealRegistry.Quadrant.H2H);
        assertEq(weighted, 0);
        assertEq(count, 0);
    }
    ...
    function testTimeWeighted_ShortHalfLife() public {
        ...
        (uint256 weighted, uint256 count) =
            sealRegistry.timeWeightedScore(human2, 1 days, false, SealRegistry.Quadrant.H2H);
